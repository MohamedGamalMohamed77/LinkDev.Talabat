...
namespace LinkDev.Talabat.Core.Application.Services
{
	public class ServiceManager : IServiceManager
	{
		...
		public ServiceManager(IUnitOfWork unitOfWork, IMapper mapper, IConfiguration configuration,Func<IOrderService> orderService,Func<IBasketService> basketServiceFactory,Func<IAuthService> authService)
		{
